...
| ---------- | ------ | --------- | ---------- | ---------- |
| 29/07/2026 | 2-4 pm | CSE Lyre | Yuheng(Andy), Sam, Ryan, Quanlin, James | Yuheng (Andy) |

## Discussed Items:
* Deduplication should be handled in the main CPU, given that coprocessor should only contain special instructions according to the specifications
